...
COBBLESTONE_ROAD_CFG = terrain_gen.TerrainGeneratorCfg(
    ...
    sub_terrains={
        ...
        "courage_gaps": CourageGapsTerrainCfg(
            proportion=0.1,
            num_gaps = 3,
            gap_width_range = (0.05, 0.45),
            gap_spacing_range = (0.8, 0.45),
            gap_depth_range = (0.1, 0.55),
        ),
...
class ObservationsCfg:
    ...
    # Separate top-level groups are required because RSL-RL 3.0.1 rollout
    # storage supports multi-dimensional tensors but not nested TensorDicts.
    proprioception: ProprioceptionCfg = ProprioceptionCfg()
    map_scans: MapScansCfg = MapScansCfg()
